...
Given the bash command "cp file1 file2", a stub might be defined to return status 0.  The stub could also echo "cp file1 file2" to standard out.  Using Bats **status**, **lines** or **output** variables
...
For this example you can verify the **status**, the **output**/**lines**, and the **capture** variables.
